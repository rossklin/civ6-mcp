...
NOTIFICATION_TOOL_MAP: dict[str, str] = {
    "NOTIFICATION_CHOOSE_TECH": "set_research(tech_name)",
    "NOTIFICATION_CHOOSE_CIVIC": "set_civic(civic_name)",
    "NOTIFICATION_CHOOSE_CITY_PRODUCTION": "set_city_production(city_id, item_type, item_name, target_x?, target_y?)",
    "NOTIFICATION_FILL_CIVIC_SLOT": "set_policies(assignments)",
    "NOTIFICATION_CONSIDER_GOVERNMENT_CHANGE": "change_government(government_type), then set_policies(assignments)",
    ...
    "NOTIFICATION_GOVERNOR_PROMOTION_AVAILABLE": "get_available_governors() then promote_governor(governor_type, promotion_type)",
    "NOTIFICATION_DEDICATION_AVAILABLE": "get_dedications() then choose_dedication(dedication_index=...)",
    "NOTIFICATION_WORLD_CONGRESS_BLOCKING": "queue_wc_votes()",
    "NOTIFICATION_WORLD_CONGRESS_RESULTS": "review results",
    "NOTIFICATION_WORLD_CONGRESS_SPECIAL_SESSION_BLOCKING": "queue_wc_votes()",
